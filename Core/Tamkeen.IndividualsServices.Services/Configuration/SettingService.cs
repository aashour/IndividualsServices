...
using Tamkeen.IndividualsServices.Core;
using System.ComponentModel;
using System.Reflection;

namespace Tamkeen.IndividualsServices.Services.Configuration
{
    public class SettingService : ISettingService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string SETTINGS_ALL_KEY = "is.setting.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string SETTINGS_PATTERN_KEY = "is.setting.";
        ...
        public SettingService(ICacheManager cacheManager, IRepository<Setting, int> settingRepository)
        {
