...
using System.IO;
using System.Text;
using Tamkeen.IndividualsServices.Data.Initializers;
...
#pragma warning disable 0618
        ...
        public virtual void SetDatabaseInitializer()
        {
            ...
            var tablesToValidate = new[] { "MOL_User", "Lookup_Job", "MOL_Establishment", "MOL_Laborer", "MOL_Owner" };
            ...
            var initializer = new CreateTablesIfNotExist<IndividualsServicesObjectContext>(tablesToValidate, customCommands.ToArray());
