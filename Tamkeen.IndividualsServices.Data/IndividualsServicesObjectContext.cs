...
{
    public class IndividualsServicesObjectContext : DbContext, IDbContext
    {
        #region Ctor
        ...
        protected virtual TEntity AttachEntityToContext<TEntity, Tkey>(TEntity entity) where TEntity : BaseEntity<Tkey>, new()
        {
            ...
            var alreadyAttached = Set<TEntity, Tkey>().Find(entity.Id);
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity, Tkey>(string commandText, params object[] parameters) where TEntity : BaseEntity<Tkey>, new()
        {
            ...
            //performance hack applied as described here - http://www.ajeerLink.com/boards/t/25483/fix-very-important-speed-improvement.aspx
