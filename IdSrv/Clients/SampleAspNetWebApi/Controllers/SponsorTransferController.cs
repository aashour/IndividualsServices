    ...
    public class SponsorTransferController : ApiController
    {
        ...
        private void AllServiceLogs()
        {
            ...
            OracleTransactionLog log1 = new OracleTransactionLog
            {
                ...
                TransactionStatus = 1,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = "12863518", FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 12863518
            };
            OracleTransactionLog log2 = new OracleTransactionLog
            {
                ...
                TimeStamp = new DateTime(2017, 4, 26),
                TransactionStatus = 1,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = 1031470568.ToString(), FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 12863518
            };
            OracleTransactionLog log3 = new OracleTransactionLog
            {
                ...
                TimeStamp = new DateTime(2017, 4, 26),
                TransactionStatus = 1,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = 1047365240.ToString(), FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 11062868
            };
            ...
            OracleTransactionLog log4 = new OracleTransactionLog
            {
                ...
                TimeStamp = new DateTime(2017, 4, 26),
                TransactionStatus = 1,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = 1076744463.ToString(), FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 172833
            };
            OracleTransactionLog log5 = new OracleTransactionLog
            {
                ...
                TimeStamp = new DateTime(2017, 4, 26),
                TransactionStatus = 1,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = 1043604378.ToString(), FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 12593634
            };
            ...
            OracleTransactionLog log6 = new OracleTransactionLog
            {
                ...
                TimeStamp = new DateTime(2017, 4, 26),
                TransactionStatus = 1,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = 1059869154.ToString(), FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 819067
            };
            OracleTransactionLog log7 = new OracleTransactionLog
            {
                ...
                TimeStamp = new DateTime(2017, 4, 26),
                TransactionStatus = 3,
                User = new Tamkeen.IndividualsServices.Core.Models.User { Id = 33, UserName = 1037748546.ToString(), FirstName = "first", SecondName = "second", ThirdName = "third", FourthName = "last" },
                UserId = 12167795
            };
