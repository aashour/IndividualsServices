...
namespace Shared.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
    public class ContainerManager
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new InvalidOperationException("Unknown dependency");
            ...
            throw new InvalidOperationException("No constructor  was found that had all the dependencies satisfied.");
        }
